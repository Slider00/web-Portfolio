...
const Coins = ({coin, index}) => {
    ...
    return (<tr className="border-b border-gray-700">
        ...
        <td className="px-4 py-3 whitespace-nowrap flex items-center gap-2">
            ...
            <span className="ml-2 text-xs sm:text-sm text-gray-400 uppercase">({coin.symbol})</span>
        </td>
        ...
        <td
            className={`px-4 py-3 text-xs sm:text-sm font-medium whitespace-nowrap ${priceChange >= 0 ? "text-green-500" : "text-red-500"}`}>
