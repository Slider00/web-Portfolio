...
export const myProjects = [
  ...
  {
    id: 12,
    title: "projects.trackingShop.title",
    description: "projects.trackingShop.description",
    subDescription: [
      "projects.trackingShop.subDescription0",
    ],
    href: "",
    logo: "",
    image: `${base}assets/projects/tracking-1.png`,
    images: [
      `${base}assets/projects/tracking-1.png`,
      `${base}assets/projects/tracking-2.png`,
      `${base}assets/projects/tracking-3.png`,
      `${base}assets/projects/tracking-4.png`,
      `${base}assets/projects/tracking-5.png`,
    ],
    tags: [
      { id: 1, name: "React", path: `${base}assets/logos/react.svg` },
      { id: 2, name: "Next.js", path: `${base}assets/logos/nextjs.svg` },
...
export const certifications = [
  {
    ...
    issuer: "Unisabaneta",
    date: "2023",
    image: `${base}assets/certificates/diploma.png`,
    link: `${base}models/diploma.pdf`,
  },
  {
    id: 2,
